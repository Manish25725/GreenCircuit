  ...
  const loadAgencyData = async () => {
    try {
      ...
      try {
        ...
        // Find pending/confirmed bookings that need attention
        const pending = bookings.filter((b: Booking) => 
            ...
            <main className="flex flex-1 justify-center py-5 mt-24">
              <div className="layout-content-container flex flex-col w-full max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                  {/* Left Column (Pending Bookings & Stats) */}
                    ...
                    <section className="flex flex-col gap-5">
                      <div className="flex items-center justify-between">
                        <h2 className="text-white text-2xl font-bold tracking-tight flex items-center gap-3">
                          ...
                          {pendingBookings.length > 0 ? `Pending Pickups (${pendingBookings.length})` : 'Pickup Requests'}
                        </h2>
                        ...
                        {loading ? (
                          ...
                          <div className="space-y-4">
                            {pendingBookings.slice(0, 5).map((booking) => (
                              <div key={booking._id} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5 hover:bg-white/10 hover:border-[#f59e0b]/20 transition-all group/item cursor-pointer" onClick={() => window.location.hash = '#/agency/bookings'}>
                                <div className="flex items-center gap-4">
                                  ...
                                  <div>
                                    ...
                                    <p className="text-gray-500 text-xs mt-1">
                                      {typeof booking.userId === 'object' ? booking.userId.name : 'Customer Request'}
                                    </p>
                                  </div>
                                </div>
                                <div className="flex items-center gap-3">
                                  ...
                                  <span className="material-symbols-outlined text-gray-500 group-hover/item:text-[#f59e0b] transition-colors">chevron_right</span>
                                </div>
                              </div>
                            ))}
                            ...
                            {pendingBookings.length > 5 && (
                              <button 
                                ...
                                className="w-full py-3 text-center text-[#f59e0b] hover:text-white text-sm font-medium border border-[#f59e0b]/20 rounded-xl hover:bg-[#f59e0b]/10 transition-all"
                              >
                                View all {pendingBookings.length} pending pickups
                              </button>
                            )}
                          </div>
                        ) : (
                          ...
                          <div className="text-center py-8">
                            ...
                            <p className="text-[#94a3b8] mb-6 max-w-md mx-auto">
                              No pending pickup requests at the moment. Check your bookings or manage your slots.
                            </p>
                            <button 
                              onClick={() => window.location.hash = '#/agency/bookings'}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-[#151F26] rounded-2xl p-6 shadow-[0_4px_12px_0_rgba(0,0,0,0.07)] flex flex-col justify-between border border-white/5 hover:border-white/10 transition-colors relative overflow-hidden group">
                          ...
                          <div>
                            ...
                            <p className="text-white text-5xl font-black leading-none tracking-tight">{stats.totalPickups} <span className="text-2xl font-medium text-gray-500">pickups</span></p>
                          </div>
                          <div className="mt-8">
                        ...
                        <div className="bg-[#151F26] rounded-2xl p-6 shadow-[0_4px_12px_0_rgba(0,0,0,0.07)] flex flex-col justify-between border border-white/5 hover:border-white/10 transition-colors relative overflow-hidden group">
                          ...
                          <div>
                            <div className="flex items-center gap-2 text-[#94a3b8] mb-3">
                              <span className="text-sm font-semibold uppercase tracking-wider">E-Waste Collected</span>
                            </div>
                            <p className="text-white text-5xl font-black leading-none tracking-tight">{stats.totalWasteCollected} <span className="text-2xl font-medium text-gray-500">items</span></p>
                          </div>
                          <div className="mt-8">
                            <div className="flex justify-between text-xs font-medium text-gray-400 mb-2">
