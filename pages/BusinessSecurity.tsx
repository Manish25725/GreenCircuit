                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handlePasswordChange}>
                      ...
                      <div className="flex justify-end pt-2">
                        <button 
                          className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#06b6d4] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#0891b2] transition-all disabled:opacity-50" 
                          type="submit"
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    <div className="flex flex-col gap-1 max-w-2xl">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#06b6d4]">security</span>
                    ...
                    <button className="flex whitespace-nowrap min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#0B1116] text-[#06b6d4] border border-white/10 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#06b6d4]/10 transition-colors">
                      Enable 2FA
                    </button>
                  </div>
                </div>
                    ...
                    <div className="flex flex-col gap-4">
                      <div className="flex items-center justify-between py-3 border-b border-white/5">
                        <div className="flex flex-col">
                          ...
                          <span className="text-[#94a3b8] text-xs">Control who can see your business profile</span>
                        </div>
