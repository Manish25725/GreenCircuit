                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                      ...
                      <div className="flex justify-end pt-2">
                        <button 
                          className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#06b6d4] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#0891b2] transition-all" 
                          type="submit"
                        >
                          Update Password
                        </button>
