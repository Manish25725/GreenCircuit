              ...
              <div className="layout-content-container flex flex-col w-full max-w-6xl">
                ...
                <div className="bg-[#151F26] p-6 md:p-8 rounded-xl border border-white/5 mb-6">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    ...
                    <button className="flex whitespace-nowrap min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#0B1116] text-[#06b6d4] border border-white/5 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#06b6d4]/10 transition-colors">
                      Enable 2FA
                    </button>
                  </div>
                </div>
