          ...
          <div className="layout-container flex h-full grow flex-col relative z-10">
            ...
            <header className="flex items-center justify-between whitespace-nowrap border-b border-white/5 px-4 sm:px-6 lg:px-10 py-4 bg-[#0B1116]/80 backdrop-blur-md fixed top-0 left-0 right-0 z-50">
              ...
              <nav className="hidden md:flex flex-1 justify-center gap-1">
                ...
                <a className="text-sm font-semibold px-5 py-2.5 rounded-full text-white bg-white/10 shadow-inner border border-white/5 cursor-pointer" onClick={() => window.location.hash = '#/history'}>History</a>
              ...
              <div className="flex items-center gap-4">
                ...
                <button 
                  ...
                  className="p-2.5 rounded-full bg-[#151F26] border border-white/5 text-gray-400 hover:text-white hover:bg-white/10 transition-colors"
