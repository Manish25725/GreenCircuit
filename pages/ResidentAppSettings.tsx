              ...
              <div className="layout-content-container flex flex-col w-full max-w-6xl">
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 bg-[#10b981]/10 rounded-lg">
                      <span className="material-symbols-outlined text-[#10b981] text-[28px]">settings</span>
                    </div>
                    <div>
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#10b981]">language</span>
                        ...
                        <button
                          ...
                          className={`p-4 rounded-xl border transition-all ${
                            settings.language === lang
                              ...
                              : 'bg-[#0B1116] border-white/10 text-gray-300 hover:border-[#10b981]/30 hover:bg-[#10b981]/5'
                ...
                <div className="bg-[#151F26] p-6 md:p-8 rounded-xl border border-white/5">
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#10b981]">display_settings</span>
...
export default ResidentAppSettings;
