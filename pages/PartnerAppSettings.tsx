              ...
              <div className="layout-content-container flex flex-col w-full max-w-6xl">
                  ...
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#8b5cf6]">language</span>
                        <h3 className="text-white text-lg font-bold leading-tight">Language</h3>
                      </div>
                      <p className="text-[#94a3b8] text-sm">Select your preferred language</p>
                    </div>
                ...
                <div className="bg-[#151F26] p-6 md:p-8 rounded-xl border border-white/5">
                  <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[#8b5cf6]">display_settings</span>
