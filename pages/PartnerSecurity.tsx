              ...
              <div className="layout-content-container flex flex-col w-full max-w-6xl">
                  ...
                  <div className="flex flex-col gap-6">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={handlePasswordChange}>
                      ...
                      <div className="flex justify-end pt-2">
                        <button 
                          className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#8b5cf6] text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#7c3aed] transition-all disabled:opacity-50" 
                          type="submit"
                ...
                <div className="bg-[#151F26] p-6 md:p-8 rounded-xl border border-white/5 mb-6">
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                    ...
                    <button className="flex whitespace-nowrap min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-[#0B1116] text-[#8b5cf6] border border-white/5 text-sm font-bold leading-normal tracking-[0.015em] hover:bg-[#8b5cf6]/10 transition-colors">
                      Enable 2FA
                    </button>
                  </div>
                </div>
